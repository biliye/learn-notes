...
- 字幕：已归档 1 个分P，约 31.2 分钟，37 行字幕，10,460 字，16 个字幕证据块。
...
- 笔记预算：推荐笔记长度 2,804-4,066 字；互动质量倍率 1.347（播放 22,483，点赞 630，收藏 1,840，投币 200，评论 203，弹幕 15，分享 128；发布于 2026-08-23，距今 12 天）。保留章节结构、关键论点、方法步骤和代表证据。
