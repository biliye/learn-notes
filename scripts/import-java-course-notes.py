#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""把 samples/java-onenote-notes/*.md（16 篇 Java 课程笔记）导入远程 learn-notes，归属 bailoayi。

V3 多用户版：X-Api-Token 通道归 ADMIN；要用 bailoayi 账号导入，必须以 Bearer JWT 调 /api/import/doc。
"""
